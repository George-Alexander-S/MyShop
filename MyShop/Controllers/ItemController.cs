...
public class ItemController : Controller
{
    ...
    /*Note:
       The Add() method ABOVE only marks the entity as added in the context and does not immediately
       persist it to the database. It is therefore not asynchronous. Update() is likewise.
       The SaveChangesAsync() method is used to persist all the changes made in the context to
